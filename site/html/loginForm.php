    ...
    <div class=" flex justify-center items-center m-12 mt-20">
        ...
        <menu>
            <ul class="grid h-0 items-center hover:text-darkerWhite grid-cols-4 transition-all text-slate-200 bg-basicDark absolute w-full overflow-hidden" id="menu">
                <li class="w-full text-center h-fit cursor-pointer hover:scale-125 duration-150 delay-75 hover:z-20 hover:rounded-xl hover:text-lighterWhite overflow-visible py-6 border-r-slate-200 border-r-2 hover:bg-basicViolet hover:border-0 transition-colors ease-in-out block"><a href="./en_site.php">All posts</a></li>
                <li class="w-full text-center h-fit cursor-pointer hover:scale-125 duration-150 delay-75 hover:z-20 hover:rounded-xl hover:text-lighterWhite overflow-visible py-6 border-r-slate-200 border-r-2 hover:bg-basicViolet hover:border-0 transition-colors ease-in-out block"><a href="./en_guild_site.php">Fraction posts</a></li>
        ...
        <section class="col-span-7 bg-basicDark">
            <div class="ml-12 w-full h-full bg-basicViolet border-t-4 border-basicWhite">
                <div class="w-1/4 h-full m-auto bg-gradient-to-l from-basicViolet via-lightViolet to-basicViolet pt-12">
                    <div class="text-center pt-20 text-4xl p-10">
                        <h1>
                            Log into nazwa forum
                        </h1>
                    </div>
